...
void ackFrame()
{
  cout << "(FROM RECEIVER SIDE TO SENDER SIDE)   Note:Acknowledgement Send by receiver" << endl;
}
...
int deliverData()
{
  ...
  cout << "Recieved Data:" << object.deliverDat << endl;
  ...
  for (int i = 0; i < Index; i++)
  {
    ...
    while (object.turn == false)
    {
      if (object.Event == true)
      {
        ...
        cout << "Time taken :" << difference << endl;
        object.canSent = true;
